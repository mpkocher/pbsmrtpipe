...
from pbsmrtpipe.tools_dev import gather_report
from pbsmrtpipe.tools.gather import run_main_gather_report

log = logging.getLogger(__name__)

class Constants(object):
    TOOL_ID = "pbsmrtpipe.tasks.gather_json"
    CHUNK_KEY = "$chunk.report_id"
    VERSION = "0.1.0"
    DRIVER = "python -m pbsmrtpipe.tools_dev.gather_json --resolved-tool-contract "
