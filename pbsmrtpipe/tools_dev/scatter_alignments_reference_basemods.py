...
from pbsmrtpipe.tools_dev import scatter_alignments_reference

log = logging.getLogger(__name__)

TOOL_ID = "pbsmrtpipe.tasks.alignment_contig_scatter_basemods"
MODULE_NAME = "pbsmrtpipe.tools_dev.scatter_alignments_reference_basemods"
