...
def get_contract_parser():
    ...
    p = get_pbparser(TOOL_ID, "0.1.0", "Filter Fasta",
    ...
    p.add_output_file_type(FileTypes.FASTA, "fasta_out", "Filtered Fasta",
                           "Filtered Fasta by sequence length Fasta",
                           "filtered.fasta")
    p.add_int("pbsmrtpipe.task_options.dev_fasta_min_length", "min_length", 50,
              "Min Sequence Length", "Minimum Sequence Length to filter")
    return p
