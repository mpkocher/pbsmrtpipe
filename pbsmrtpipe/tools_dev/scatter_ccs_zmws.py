...
from pbsmrtpipe.tools_dev.scatter_subread_zmws import get_contract_parser_impl
...
class Constants(object):
    TOOL_ID = "pbsmrtpipe.tasks.ccsset_zmw_scatter"
    DEFAULT_NCHUNKS = 5
    DRIVER_EXE = "python -m pbsmrtpipe.tools_dev.scatter_ccs_zmws --resolved-tool-contract "
